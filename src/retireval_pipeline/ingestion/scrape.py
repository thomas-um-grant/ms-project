# Scrape Azure Container for consulting pdfs:
# az storage blob download-batch \
# --account-name sherpapublicdata \
# --destination /Users/thomas/repos/imperial/project/ms-project/src/data/consulting-documents \
# --source consulting-documents
